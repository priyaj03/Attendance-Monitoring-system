...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] yearString = new String[] {"B TECH","MSC","BE"};
	private String[] subjectSEString = new String[] {"INFORMATION SECURITY","MOBILE COMPUTING"};
	private String[] subjectTEString = new String[] {"INTEGRATED PROGRAMMING","COMPUTER NETWORKS"};
	private String[] subjectBEString = new String[] {"DATA STRUCTURE","PDS"};

	private String[] subjectFinal = new String[] {"INFORMATION SECURITY","MOBILE COMPUTING","IP","CN","VT","PDS"};
